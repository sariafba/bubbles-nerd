...
class LessonService
{
    ...
    public function create( array $data)
    {
        try {
            ...
            $lesson = $this->lessonRepository->create(Arr::only($data,[ 'name',  'description','video','unit_id']));
    ...
    {
        try {
            $lesson = $this->lessonRepository->update(Arr::only($data,[ 'name',  'description','video','unit_id']),$id);
